export default class winningTwoScene extends Phaser.Scene {
    constructor() {
        super("winningTwoScene");
    }
    ...
    create() {
       ...
       // Next
        ...
        nextButton.on('pointerdown', () => {
            this.scene.start('levelThreeScene', { hearts: this.hearts, score: this.score, coin: this.coin });
            this.sound.stopAll();
        });
